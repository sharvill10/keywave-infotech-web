    ...
    <section className="bg-gray-100 py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <h2 className="text-3xl font-semibold text-orange-600 mb-6">Our Mission</h2>
          ...
          >
            <h2 className="text-3xl font-semibold text-orange-600 mb-6">Company Overview</h2>
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                <FiAward className="text-orange-500 mr-3 flex-shrink-0" />
        ...
        >
          <h2 className="text-3xl font-semibold text-orange-600 mb-6">Our Partner: SHINHO</h2>
